...
CREATE TABLE IF NOT EXISTS website_forms (
  ...
  list_id UUID NOT NULL REFERENCES customer_lists(id) ON DELETE RESTRICT,
  ...
  whatsapp_sequence_id UUID REFERENCES whatsapp_sequences(id) ON DELETE SET NULL,
  sms_sequence_id UUID REFERENCES sms_sequences(id) ON DELETE SET NULL,
