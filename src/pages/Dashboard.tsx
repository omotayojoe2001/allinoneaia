    ...
    <div className="flex-1 overflow-y-auto bg-background p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {aiSuggestions.length > 0 && (
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-lg p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              {aiSuggestions.map((s, i) => (
                <Link key={i} to={s.action} className="flex items-center gap-2 p-2 rounded hover:bg-background/50 transition-colors">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="bg-card border rounded-lg p-4">
            ...
            <p className="text-xl font-bold truncate">{formatAmount(stats.revenue || 0)}</p>
          ...
          <div className="bg-card border rounded-lg p-4">
            ...
            <p className="text-xl font-bold truncate">{formatAmount(stats.expense || 0)}</p>
          ...
          <div className="bg-card border rounded-lg p-4">
            ...
            <p className="text-xl font-bold truncate">{formatAmount(stats.profit || 0)}</p>
          ...
          <div className="bg-card border rounded-lg p-4">
            ...
            <p className="text-xl font-bold">{stats.pendingInvoices || 0}</p>
          ...
          <div className="bg-card border rounded-lg p-4">
            ...
            <p className="text-xl font-bold truncate">{formatAmount(stats.totalStock || 0)}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-card border rounded-lg p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm text-muted-foreground">{stats.completedTasks}/{stats.totalTasks}</span>
            </div>
          ...
          <div className="bg-card border rounded-lg p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm text-muted-foreground">{stats.collectionRate?.toFixed(0)}%</span>
            </div>
            <div className="w-full bg-secondary rounded-full h-2">
          ...
          <div className="bg-card border rounded-lg p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm text-muted-foreground">{stats.emailOpenRate?.toFixed(1)}%</span>
            </div>
            <div className="w-full bg-secondary rounded-full h-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-card border rounded-lg p-4">
            ...
            <div className="space-y-2">
              ...
              {lowStockItems.length === 0 && <p className="text-sm text-muted-foreground">All items in stock</p>}
            </div>
          </div>
          {/* Upcoming Events */}
          <div className="bg-card border rounded-lg p-4">
            ...
            <div className="space-y-2">
              {upcomingEvents.map((e, i) => (
                <div key={i} className="flex items-start gap-2 text-sm py-1">
                  <div className={`w-2 h-2 rounded-full mt-1.5 ${e.type === 'appointment' ? 'bg-blue-500' : 'bg-green-500'}`} />
