...
import SocialManagerPage from "../SocialManagerPage";
...
const SocialMediaHub = () => {
  ...
  const tabs = [
    { id: "manager", label: "Manager", component: SocialManagerPage },
    { id: "scheduler", label: "Scheduler", component: SocialScheduler },
    { id: "growth", label: "Growth", component: GrowthServices },
  ];
